...
const newsApiService = new (0, _fetchCountriesJsDefault.default)();
refs.searchBoxEl.addEventListener("input", debounce(onInputSearch, DEBOUNCE_DELAY));
function onInputSearch(e) {
    ...
    if (newsApiService.query.length) newsApiService.fetchArticles().then((countriesArray)=>{
        console.log(countriesArray);
        if (countriesArray.length > 10) {
            (0, _notiflixDefault.default).Notify.info("Too many matches found. Please enter a more specific name");
            return;
        } else if (countriesArray.length < 10 && countriesArray.length >= 2) countryListEl.insertAdjacentHTML("beforeend", oneCountry(countriesArray));
        else countryInfoEl.insertAdjacentHTML("beforeend", countryMarkup(countriesArray));
    }).catch((err)=>{
        console.log(err);
...
},{"./css/styles.css":"1CY4s","./fetchCountries.js":"fTQqv","notiflix":"5WWYd","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"fTQqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
